...
```{r gpaallpoints}
#bring in TPS file
bees<-readland.tps('C:/Users/hrlexd/Dropbox/PlantAndFood (1)/NativeBees/Bee_pictures/Forewings_19_05_2025_29_05_25merged_ejd.TPS',specID = 'imageID',negNA = TRUE)
...
names(col_baz)<-as.character(unique(PCaxis$bee_species_baz))
col_baz
#plot
ggplot(PCaxis,aes(x=Comp1,y=Comp2,colour = bee_species))+
...
bee_links<-read.table('C:/Users/hrlexd/Dropbox/PlantAndFood (1)/NativeBees/Bee_pictures/Sam_april/Forewing/links_all_landmarks_sam.txt',sep=',',header=F)
#find mean shape
...
#Sample_names
bees_leioproctus <- bees[,,-c(2:6,11:15,31:35,53,56:61,72:73,79:83)] 
...
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#mart barry
gpl.mn<-mshape(beesgpa$coords[,,57:61])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#pekanui
gpl.mn<-mshape(beesgpa$coords[,,72:73])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#hudsoni barry
gpl.mn<-mshape(beesgpa$coords[,,53])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
...
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#bolt barry
gpl.mn<-mshape(beesgpa$coords[,,c(46:50)])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#huakiwi
gpl.mn<-mshape(beesgpa$coords[,,c(16:20,51:52)])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#huakiwi barry
gpl.mn<-mshape(beesgpa$coords[,,54:55])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#imat
...
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#pango barry
gpl.mn<-mshape(beesgpa$coords[,,68:71])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#vest
...
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#purp
gpl.mn<-mshape(beesgpa$coords[,,74:78])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#waiponamu barry
gpl.mn<-mshape(beesgpa$coords[,,84:88])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#keehua barry
gpl.mn<-mshape(beesgpa$coords[,,56])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
#metalicus
gpl.mn<-mshape(beesgpa$coords[,,62:67])
#plotRefToTarget(M1=ref,M2=gpl.mn,mag=2)
plotRefToTarget(M1=ref,M2=gpl.mn,mag=2,links=bee_links)
...
#metal, bolt kanap seem largest in general for forewing
